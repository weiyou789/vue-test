...
/******/ 	var hotCurrentHash = "c3dbc8b2511cb1c78cd7"; // eslint-disable-line no-unused-vars
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return isAttr; });
/* unused harmony export isBooleanAttr */
/* unused harmony export isNonPhrasingTag */
/* unused harmony export makeMap */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return isHTMLTag; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return isSVG; });
/* harmony export (immutable) */ __webpack_exports__["a"] = toString;
/* unused harmony export camelize */
/* unused harmony export capitalize */
/* unused harmony export resolveAsset */
...
/* harmony export (immutable) */ __webpack_exports__["p"] = cached;
/* unused harmony export no */
/* unused harmony export isPlainObject */
/* unused harmony export isNative */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return _Set; });
/* harmony export (immutable) */ __webpack_exports__["h"] = parsePath;
/* harmony export (immutable) */ __webpack_exports__["j"] = remove;
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return nextTick; });
/* harmony export (immutable) */ __webpack_exports__["d"] = warn;
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return hasProto; });
...
/* harmony export (immutable) */ __webpack_exports__["f"] = hasOwn;
/* harmony export (immutable) */ __webpack_exports__["o"] = noop;
/* harmony export (immutable) */ __webpack_exports__["r"] = def;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dep__ = __webpack_require__(6);
...
var Watcher = function () {
  function Watcher(vm, expOrFn, cb, options) {
    ...
    this.deps = [];
    this.newDeps = [];
    this.depIds = new __WEBPACK_IMPORTED_MODULE_2__utils__["g" /* _Set */]();
    this.newDepIds = new __WEBPACK_IMPORTED_MODULE_2__utils__["g" /* _Set */]();
    this.expression = expOrFn.toString();
    // parse expression for getter
    if (typeof expOrFn === 'function') {
      this.getter = expOrFn;
    } else {
      this.getter = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["h" /* parsePath */])(expOrFn);
      if (!this.getter) {
  ...
  _createClass(Watcher, [{
    ...
    value: function get() {
      ...
      if (this.user) {
        try {
          ...
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["d" /* warn */])('getter for watcher "' + this.expression + '"');
        }
      } else {
        value = this.getter.call(vm, vm);
      }
    ...
    value: function run() {
      if (this.active) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["i" /* isObject */])(value) || this.deep) {
          //设置新值
          ...
          if (this.user) {
            try {
              ...
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["d" /* warn */])('callback for watcher "' + this.expression + '"');
            }
          } else {
            this.cb.call(this.vm, value, oldValue);
          }
    ...
    value: function teardown() {
      if (this.active) {
        ...
        if (!this.vm._isBeingDestroyed) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["j" /* remove */])(this.vm._watchers, this);
        }
        var i = this.deps.length;
        while (i--) {
...
var seenObjects = new __WEBPACK_IMPORTED_MODULE_2__utils__["g" /* _Set */]();
...
function _traverse(val, seen) {
  ...
  if (!isA && !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["i" /* isObject */])(val) || !Object.isExtensible(val)) {
    return;
  }
  if (val.__ob__) {
...
var Dep = function () {
    ...
    _createClass(Dep, [{
        ...
        value: function removeSub(sub) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["j" /* remove */])(this.subs, sub);
        }
        //computed获取值的时候收集依赖
...
function setElAttrs(el, delimiters) {
    ...
    for (var key in attrs) {
        ...
        if (match) {
            value = match[1];
            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["n" /* isAttr */])(key)) {
...
function processIfConditions(el, parent) {
    ...
    if (prev) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["d" /* warn */])('v-' + (el.elseif ? 'else-if="' + el.elseif + '"' : 'else') + ' ' + ('used on element <' + el.tag + '> without corresponding v-if.'));
    }
}
...
function makeFunction(code) {
    try {
        ...
        return __WEBPACK_IMPORTED_MODULE_0__utils__["o" /* noop */];
    }
}
...
/* harmony export (immutable) */ __webpack_exports__["b"] = initMethods;
...
var sharedPropertyDefinition = {
    enumerable: true,
    configurable: true,
    get: __WEBPACK_IMPORTED_MODULE_1__utils__["o" /* noop */],
    set: __WEBPACK_IMPORTED_MODULE_1__utils__["o" /* noop */]
};

function initData(wm, data) {
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils__["q" /* isFunction */])(data)) {
        data = data();
    }
...
function initMethods(vm, methods) {
    ...
    for (var key in methods) {
        vm[key] = methods[key] == null ? __WEBPACK_IMPORTED_MODULE_1__utils__["o" /* noop */] : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils__["e" /* bind */])(methods[key], vm);
    }
}
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__html_parser__["a" /* default */])(template, {
        ...
        start: function start(tag, attrs, unary) {
            var element = {
                ...
                children: [],
                events: {},
                isComponent: !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["l" /* isHTMLTag */])(tag) && !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["m" /* isSVG */])(tag),
                nativeEvents: {},
                style: null,
                hook: {},
                props: {}, //DOM属性
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_snabbdom_modules_props__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_snabbdom_modules_attributes__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_snabbdom_modules_style__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_snabbdom_modules_eventlisteners__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_snabbdom_htmldomapi__ = __webpack_require__(4);
...
var snabbdom = __webpack_require__(19);
...
var h = __webpack_require__(1).default;
var VNode = __webpack_require__(2).default;
...
var vnode_1 = __webpack_require__(2);
var is = __webpack_require__(5);
var htmldomapi_1 = __webpack_require__(4);
function isUndef(s) {
    return s === undefined;
}
function isDef(s) {
...
['push', 'pop', 'shift', 'unshift', 'splice', 'sort', 'reverse'].forEach(function (method) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["r" /* def */])(arrayMethods, method, function mutator() {
...
var arrayKeys = Object.getOwnPropertyNames(__WEBPACK_IMPORTED_MODULE_2__array__["a" /* arrayMethods */]);
var Observer = function () {
    function Observer(value) {
        _classCallCheck(this, Observer);

        this.value = value;
        this.dep = new __WEBPACK_IMPORTED_MODULE_1__dep__["c" /* default */]();
        this.vmCount = 0; //$date的属性个数
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["r" /* def */])(value, '__ob__', this);
        //console.log(value);
        if (Array.isArray(value)) {
            //判断data是不是数组
            //判断是否能访问原型链上属性for兼容
            var augment = __WEBPACK_IMPORTED_MODULE_0__utils__["s" /* hasProto */] ? protoAugment : copyAugment;
            augment(value, __WEBPACK_IMPORTED_MODULE_2__array__["a" /* arrayMethods */], arrayKeys); //给数组原型上添加新的数组方法
...
function defineReactive(obj, key, val) {
    var dep = new __WEBPACK_IMPORTED_MODULE_1__dep__["c" /* default */]();
    var property = Object.getOwnPropertyDescriptor(obj, key); //获取每个属性特征描述
    if (property && property.configurable === false) {
        //如果属性特征描述存在，并且不能配置就返回
        return;
    }
    var getter = property && property.get;
    var setter = property && property.set;
    //console.log(val);
    var childOb = observe(val); //如果对象里面还有对象则递归调用observe方法,每次成功调用observe函数都返回observer的实例
    Object.defineProperty(obj, key, {
        get: function reactiveGetter() {
            var value = getter ? getter.call(obj) : val;

            //当有依赖关系时，收集依赖
            if (__WEBPACK_IMPORTED_MODULE_1__dep__["c" /* default */].target) {
                //把自己添加到依赖
                dep.depend();
                if (childOb) {
                    //访问子的时候会冒泡去访问父
...
function observe(value, asRootData) {
    if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["i" /* isObject */])(value)) {
        //如果不是对象就返回
        return;
    }
    var ob = void 0;
    //已经存在observer,不再赋值
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["f" /* hasOwn */])(value, '__ob__') && value.__ob__ instanceof Observer) {
        ob = value.__ob__;
    } else {
...
function copyAugment(target, src, keys) {
    for (var i = 0, l = keys.length; i < l; i++) {
        var key = keys[i];
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["r" /* def */])(target, key, src[key]);
    }
}
...
function queueWatcher(watcher) {
    ...
    if (has[id] == null) {
        ...
        if (!waiting) {
            waiting = true;
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils__["k" /* nextTick */])(flushSchedulerQueue);
        }
    }
}
...
var buildRegex = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["p" /* cached */])(function (delimiters) {
...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_observer_watcher__ = __webpack_require__(3);
...
var WVM = function () {
    function WVM(options) {
        _classCallCheck(this, WVM);
        ...
        if (options.methods) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__core_instance__["b" /* initMethods */])(this, options.methods);
        }
    ...
    _createClass(WVM, [{
        ...
        value: function _render() {
            ...
            try {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__core_utils__["d" /* warn */])('render Error : ' + e);
            }
            console.log(vnode);
            return vnode;
        }
        ...
        value: function _h(sel, data, children) {
            ...
            if (this.$options.destroy) {
                data.hook.destroy = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__core_utils__["e" /* bind */])(this.$options.destroy, this);
            }
        ...
        value: function $set(target, key, val) {
            ...
            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__core_utils__["f" /* hasOwn */])(target, key)) {
                target[key] = val;
                return val;
            }
...
/* harmony default export */ __webpack_exports__["default"] = (WVM);


function callHook(wm, hook) {
    var handlers = wm.$options[hook];
    if (handlers) {
        if (Array.isArray(handlers)) {
...
WVM.use(__WEBPACK_IMPORTED_MODULE_5__plugin_directives__["a" /* directive */]);
WVM.use(__WEBPACK_IMPORTED_MODULE_6__plugin_event__["a" /* event */]);
global.WVM = WVM;
